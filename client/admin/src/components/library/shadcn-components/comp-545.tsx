...
import { useFileUpload } from "@/components/library/shadcn-components/hooks/use-file-upload";
        ...
        >
          ...
          {previewUrl ? (
            <div className="absolute inset-0 flex items-center justify-center p-4">
              <img src={previewUrl} alt={files[0]?.file?.name || "Uploaded image"} className="mx-auto max-h-full rounded object-contain" />
            </div>
          ) : (
