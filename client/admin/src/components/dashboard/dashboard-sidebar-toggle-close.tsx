...
const DashboardSidebarToggleClose: FC<DashboardSidebarToggleCloseProps> = ({ open, setOpen }) => {
  return (
    <motion.div layout onClick={() => setOpen(prev => !prev)} className="absolute right-0 bottom-0 left-0 border-t border-slate-300 transition-colors hover:bg-slate-100">
