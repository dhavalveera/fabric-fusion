export type ButtonTextItemProps = {
  color: string;
  hover: string;
  active: string;
};
...
export type ButtonTextProps = {
  white: ButtonTextItemProps;
  black: ButtonTextItemProps;
  "blue-gray": ButtonTextItemProps;
  gray: ButtonTextItemProps;
  brown: ButtonTextItemProps;
  "deep-orange": ButtonTextItemProps;
  orange: ButtonTextItemProps;
  amber: ButtonTextItemProps;
  yellow: ButtonTextItemProps;
  lime: ButtonTextItemProps;
  "light-green": ButtonTextItemProps;
  green: ButtonTextItemProps;
  teal: ButtonTextItemProps;
  cyan: ButtonTextItemProps;
  "light-blue": ButtonTextItemProps;
  blue: ButtonTextItemProps;
  indigo: ButtonTextItemProps;
  "deep-purple": ButtonTextItemProps;
  purple: ButtonTextItemProps;
  pink: ButtonTextItemProps;
  red: ButtonTextItemProps;
};
