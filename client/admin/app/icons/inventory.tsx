...
const InventoryIcon = forwardRef<SVGSVGElement, InventoryIconProps>(({ title, titleId, ...props }, ref) => {
  return (
    <svg focusable="false" fill="none" stroke="currentColor" aria-hidden="true" viewBox="0 0 24 24" ref={ref} aria-labelledby={titleId} {...props}>
      ...
      <path d="M21 7v11.6c0 1.33-1.07 2.4-2.4 2.4H5.4C4.07 21 3 19.93 3 18.6V7" className="stroke-black dark:stroke-white" strokeWidth={1.5} strokeMiterlimit={10} strokeLinecap="round" />
      <path
        ...
        strokeMiterlimit={10}
      />
      <path d="M8 11h8" className="stroke-black dark:stroke-white" strokeWidth={1.5} strokeMiterlimit={10} strokeLinecap="round" />
    </svg>
  );
});
